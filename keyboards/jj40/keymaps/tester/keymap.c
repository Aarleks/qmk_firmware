...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
	...
	case WESTERN:
	    if (record->event.pressed) {
		// send the sting
		SEND_STRING("A.Norman@westernsydney.edu.au");
	    } else {
		// do nothing
	    }
	    break;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MACRO] = LAYOUT_planck_1x2uR(
	    _______, _______, WESTERN, _______, _______, _______, KC_DOWN, KC_RIGHT, _______, _______, _______, _______,\
	    _______, AARLEKS, _______, UNI_ID, _______, _______, KC_LEFT, _______, _______, _______, _______, _______,\
	    _______, _______, _______, _______, _______, _______, KC_UP, MY_MAIL, _______, _______, _______, _______,\
	    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______\
	    ),
